...
IF(UMFPACK_LIBS_ONLY)
  ...
  FIND_LIBRARY(UMFPACK_LIBRARIES NAMES umfpack libumfpack UMFPACK libUMFPACK
               ...
               PATHS "${UMFPACK_ROOT}" "${UMFPACK_ROOT}/lib"
               NO_DEFAULT_PATH)
...
ELSEIF(UMFPACK_LIBS_ONLY)
  ...
  IF(UMFPACK_INCLUDE_DIRS)
    ...
    FIND_LIBRARY(UMFPACK_LIBRARIES NAMES umfpack libumfpack UMFPACK libUMFPACK
                 PATH_SUFFIXES ${CMAKE_LIBRARY_ARCHITECTURE}
                 PATHS ${UMFPACK_LIBRARY_DIRS} NO_DEFAULT_PATH)

    # If we find an AMD installation in a similar directory, it's probably required by UMFPACK
    FIND_LIBRARY(UMFPACK_AMD_LIBRARY NAMES amd AMD libamd libAMD
                 PATH_SUFFIXES ${CMAKE_LIBRARY_ARCHITECTURE}
                 PATHS ${UMFPACK_LIBRARY_DIRS} NO_DEFAULT_PATH)
