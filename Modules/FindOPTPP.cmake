...
IF(OPTPP_INCLUDE_DIRS)
  ...
  # Look for libopt
  FIND_LIBRARY(OPTPP_DEBUG_LIBRARY NAMES opt_d libopt_d optd liboptd
  ...
  FIND_LIBRARY(OPTPP_RELEASE_LIBRARY NAMES opt libopt
  ...
  # Look for libnewmat
  IF(OPTPP_LIBRARIES)
    FIND_LIBRARY(OPTPP_NEWMAT_DEBUG_LIBRARY NAMES newmat_d libnewmat_d newmatd libnewmatd
                 PATH_SUFFIXES Debug ${CMAKE_LIBRARY_ARCHITECTURE} ${CMAKE_LIBRARY_ARCHITECTURE}/Debug
                 PATHS ${OPTPP_LIBRARY_DIRS} ${OPTPP_LIBRARY_DIRS}/lib NO_DEFAULT_PATH)

    FIND_LIBRARY(OPTPP_NEWMAT_RELEASE_LIBRARY NAMES newmat libnewmat
                 PATH_SUFFIXES Release ${CMAKE_LIBRARY_ARCHITECTURE} ${CMAKE_LIBRARY_ARCHITECTURE}/Release
                 PATHS ${OPTPP_LIBRARY_DIRS} ${OPTPP_LIBRARY_DIRS}/lib NO_DEFAULT_PATH)
